...
class TestDefaultPagination(unittest.TestCase):
    def test_1_start_services(self):
        print("######################defaultPagination: Service starting....###################")
    ...
    def test_2_post_data(self):
        print("######################defaultPagination: Data ingesting....###################")
    ...
    def test_3_verify_view(self):
        print("######################defaultPagination: Verify first view....###################")
    ...
    def test_5_verify_random_page(self):
        print("######################defaultPagination: Verify fragments with randome page....###################")

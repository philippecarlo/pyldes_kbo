...
su = Support()
url_view_by_page = "http://localhost:8080/kbo/by-time"
url_first_fragment = "http://localhost:8080/kbo/by-time?"
url_random_page = "http://localhost:8080/kbo/by-time?"
docker_compose_file = "../../cegekaKBO/cegeka_kbo_substring/docker-compose.yml"
data_location = "../../sample/bel20/*"


class TestDefaultTimebase(unittest.TestCase):
    def test_1_start_services(self):
        print("#####################defaultTimebased:Service starting....##########################")
        time.sleep(20)
    ...
    def test_2_post_data(self):
        print("#####################defaultTimebased:Data ingesting....##########################")
    ...
    def test_3_verify_view(self):
        print("#####################defaultTimebased:View verify..")
        graph_expected = Graph().parse('../expected/expected_timebase/view.turtle', format='turtle')
    ...
    def test_4_verify_fist_page(self):
         print("#####################defaultTimebased:View verify..")
         graph_expected = Graph().parse('../expected/expected_timebase/page1.turtle', format='turtle')
    ...
    def test_5_verify_random_page(self):
        print("#####################defaultTimebased:Random fragment verify...#############")
        graph_expected = Graph().parse('../expected/expected_timebase/random.turtle', format='turtle')
    ...
    def test_6_tear_down(self):
        print("#####################defaultTimebased:Tear down....##########################")
